...
- Avant de commencer le TP, il faut importer le fichier 'products-bulk.json'.Puis on va l'enregistrer dans l'index 'products' (Section 03. a - Import Data to Cloud)
