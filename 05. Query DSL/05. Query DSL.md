## Introduction à la Recherche <sub>(fondamentale)</sub>
...
- Les requêtes au niveau des termes sont généralement utilisées pour les données structurées telles que les nombres, 
  les dates et les énumérations, plutôt que pour les champs de texte intégral
